  ...
  return (
    <Flex direction="column" gap="md">
      <Card>
        ...
        <p>
          For the last century or so, the electricity grid has been busy quietly
          helping to power comfortable modern lives. A somewhat thankless task,
          and without much in the way of excitement. The 21st century has
          changed all of that, and it's now a hotbed of innovation and
          technology. After decades of quiet service, it's now being asked to
          rapidly adapt, and unlock exciting potential energy pathways.
        </p>
        <p>
      ...
      <Card>
        ...
        <p>
          Me! My name is Eddie Sholl, I'm an experienced software engineer with
          a keen interest in the intersection of technology and sustainability.
          You can find me on{" "}
